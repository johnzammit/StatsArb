...
class MarketState:
    ...
    def initialize():
        # We want to maintain a window of length window_size throughout the whole trading process
        # This means that we need to start out with a window of length window_size

        # First get window_size amount of data, which ends at the current moment
